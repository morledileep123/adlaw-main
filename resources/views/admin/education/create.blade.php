    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Add new education</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <option value="">--select collect--</option>
                  @foreach ($catgQual as $catg) 
                  <option value="{{$catg->qual_catg_code}}">
                  {{$catg->qual_catg_desc}}
                  </option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="qual_desc" id="exampleInputEducation" placeholder="Enter Education name">
              </div>
              <div class="form-group">
                <label for="exampleInputShort">Short desription</label>
                <input type="text" class="form-control" name="shrt_desc" id="exampleInputShort" placeholder="Enter short desription name">
              </div>
            </div>
            <!-- /.card-body -->
