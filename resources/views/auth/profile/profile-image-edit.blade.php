          ...
          <form action="{{ route('profile.pic.update', ['id'=>Auth::user()->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="id" id="id" class="form-control" value="{{ $profilePic[0]->user_id }}">
                <input type="file" name="photo_path" id="image" class="form-control"><br>
                @if($profilePic[0]->photo_path !=null)
                <img src="/public/profile-image/{{ $profilePic[0]->photo_path }}" id="preview-image-before-upload" width="150px" height="150px">
                @else
