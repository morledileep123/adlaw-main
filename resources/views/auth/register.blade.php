        ...
        <div class="container-fluid bg-dark p-0">
            ...
            <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
                ...
                <div class="login-logo">
                    <u style="color:grey"><a href="#"><b>Adlaw</b>REGISTERATION</a></u>
                </div>
                @if(session('success'))
                    ...
                    <div class="card-body login-card-body">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group mb-3">
                                <select class="form-control" style="width: 100%;" name="user_type_id" data-placeholder="Select User Type">
                                    @foreach ($userType as $user)
                                    <option value="{{ $user->user_type_id }}">{{ $user->user_type_desc }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" placeholder="User Name" id="name" value="{{ old('user_name') }}" class="form-control" name="user_name" autofocus>
                            ...
                            @endif
                            <div class="input-group mb-3">
                            <input type="number" placeholder="Mobile Number" id="mobile" value="{{ old('mobile') }}" class="form-control" name="mobile" autofocus>
                                <div class="input-group-append">
                                    <div class="input-group-text">
                            ...
                            @endif
                            <div class="input-group mb-3">
                                <input type="text" placeholder="Email" id="email" value="{{ old('email') }}" class="form-control" name="email" autofocus>
                                <div class="input-group-append">
                                    <div class="input-group-text">
                            ...
                            <div class="row">
                                <div class="col-4">
                                <button type="submit" class="btn btn-primary btn-block" style="float:left">Register</button>
                            </div>
                            <!-- /.col -->
                            <div class="col-8">
                                <a href="{{ route('login') }}" class="text-center">Already registered please login</a>
                            </div>
                            <!-- /.col -->
                            </div>
                        </form>
